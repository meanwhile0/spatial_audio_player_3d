...
@onready var footsteps_audio: SpatialAudioPlayer3D = $FootstepsAudio
...
#region Footsteps Export Group

@export_group("Footsteps")
## Enable or disable footstep sounds.
@export var footsteps_enabled : bool = true
## Time in seconds between footstep sounds when walking at base speed.
@export var footstep_interval : float = 0.5
## Time in seconds between footstep sounds when sprinting.
@export var footstep_sprint_interval : float = 0.35
## Time in seconds between footstep sounds when crouching.
@export var footstep_crouch_interval : float = 0.75
...
func handle_footsteps(delta: float, input_dir: Vector2):
